    ...
    switch (command) {
        case "help": {
            const help = [
                ...
                "0: 矩形波(デューティ比50%), 1: 矩形波(デューティ比25%), 2: 矩形波(デューティ比12.5%), 3: 三角波, 4: ノコギリ波, 5: サイン波, 6: ホワイトノイズ, 7: 矩形波2(50%), 8: 矩形波2(25%), 9: 矩形波2(12.5%)",
                "@Ea,d,s,r ADSRエンベロープを設定します。",
                "@Un,d n個の音をd重ねて出力します。",
                "[]n 括弧で囲んだ範囲をn回繰り返します。",
                "# エフェクトを掛けます。以下のエフェクターに対応しています。",
                "Lf,q ローパスフィルター(f: カットオフ周波数, r: レゾナンス) Hf,q ローパスフィルター Ef,d エコー(f: フィードバック, d: ディレイ)",
